<template>
  <MainLayout>
    <div class="mx-auto max-w-7xl px-6 py-24 text-center">
      <p class="text-9xl font-bold text-green-100">404</p>
      ...
      <RouterLink to="/" class="mt-8 inline-block rounded-lg bg-green-600 px-6 py-3 font-medium text-white transition-colors hover:bg-green-700">
        Back to Home
      </RouterLink>
    </div>
  </MainLayout>
